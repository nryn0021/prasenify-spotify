...
export default function Body({ headerBackground }) {
  ...
  useEffect(() => {
    const getInitialPlaylist = async () => {
      ...
      dispatch({ type: reducerCases.SET_PLAYLIST, selectPlaylist });
    };
    getInitialPlaylist();
        ...
        <div>
          <div className="playlist">
            ...
            <div className="details">
              ...
              <h1 className="title">{selectPlaylist.name}</h1>
              <p className="description">{selectPlaylist.description}</p>
            </div>
          </div>
          <div className="list">
